...
enum TargetLayer{Nothing = 0, World = 1, PlayerCol = 2, PlayerHitbox = 4, EnemyCol = 8, EnemyHitbox = 16}
...
func shape(myself: Node2D, shape2d: Shape2D, layers: int, max_results: int = 1, bodies: bool = true, areas: bool = false, exclude_self: bool = true, space_state: PhysicsDirectSpaceState2D = null)->Array[Dictionary]:
	if(space_state == null):
		space_state = myself.get_world_2d().direct_space_state
